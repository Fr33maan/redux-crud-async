...
module.exports = function (primaryModel, associatedModel, hostConfig) {
  ...
  return _ref6 = {}, _defineProperty(_ref6, findPrimaryAssociatedModels, function (primaryModelId, associatedModelId) {
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'get', baseUrl + '/' + urlPrimaryModel + '/' + primaryModelId + '/' + urlAssociatedModel + associatedModelId, headers[findPrimaryAssociatedModels])
    ...
    if ('id' in modelToAssociate) {
      return function (dispatch) {
        ...
        return providerUtil(hostConfig, 'post', baseUrl + '/' + urlPrimaryModel + '/' + primaryModelId + '/' + urlAssociatedModel + '/' + modelToAssociate.id, headers[addAssociatedModelToPrimary])
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'post', baseUrl + '/' + urlPrimaryModel + '/' + primaryModelId + '/' + urlAssociatedModel + '/' + modelToDissociate.id, headers[removeAssociatedModelFromPrimary])
