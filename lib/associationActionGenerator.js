...
module.exports = function (primaryModel, associatedModel, hostConfig) {
  ...
  return _ref6 = {}, _defineProperty(_ref6, findPrimaryAssociatedModels, function (primaryModelId, associatedModelId, parameters) {
    ...
    return function (dispatch) {
      ...
      var url = baseUrl + '/' + urlPrimaryModel + '/' + primaryModelId + '/' + urlAssociatedModel + associatedModelId + parameters;
