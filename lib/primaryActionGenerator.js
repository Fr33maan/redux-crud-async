...
module.exports = function (modelName, hostConfig) {
  ...
  if (authConfig && hasSessionStorage) {
    ...
    authConfig.forEach(function (action) {
      ...
      bearers[action] = function () {
        var JWT_Token = windowAccess.sessionStorage.getItem(sessionStorageName);
  ...
  return _ref5 = {}, _defineProperty(_ref5, findModel, function (modelId) {
    ...
    return function (dispatch) {
      ...
      var bearer = typeof bearers[findModel] !== 'undefined' ? bearers[findModel]() : undefined;

      return axios.get(baseUrl + '/' + urlModel + '/' + modelId, bearer).then(function (res) {
    ...
    return function (dispatch) {
      ...
      var bearer = typeof bearers[findModels] !== 'undefined' ? bearers[findModels]() : undefined;

      return axios.get(baseUrl + '/' + urlModel + request, bearer).then(function (res) {
        return dispatch(success(res.data.data));
      }).catch(function (res) {
    ...
    return function (dispatch) {
      console.log(typeof FormData === 'undefined' ? 'undefined' : _typeof(FormData));
      ...
      try {
        var bearer = typeof bearers[createModel] !== 'undefined' ? bearers[createModel]() : undefined;
        return axios.post(baseUrl + '/' + urlModel, modelToCreate, bearer).then(function (res) {
