...
module.exports = function (modelName, hostConfig) {
  ...
  console.log('test');
  var headers = bearerUtil(windowAccess, hostConfig, singleModelName);
  console.log('test1');
  ...
  return _ref5 = {}, _defineProperty(_ref5, findModel, function (modelId) {
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'get', baseUrl + '/' + urlModel + '/' + modelId, headers[findModel])
