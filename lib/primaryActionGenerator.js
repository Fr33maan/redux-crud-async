...
module.exports = function (modelName, hostConfig) {
  ...
  return _ref5 = {}, _defineProperty(_ref5, 'find' + singleModelNameCap, function (modelId) {
    function start() {
    ...
    return function (dispatch) {
      ...
      dispatch(start());
      return axios.get(baseUrl + '/' + urlModel + '/' + modelId).then(function (res) {
        return dispatch(success(res.data.data));
      }).catch(function (res) {
        return dispatch(error(res.data, modelId));
      });
    };
  }), _defineProperty(_ref5, 'find' + pluralModelNameCap, function () {
    ...
    return function (dispatch) {
      dispatch(start());
      return axios.get(baseUrl + '/' + urlModel + request).then(function (res) {
        return dispatch(success(res.data.data));
      }).catch(function (res) {
        return dispatch(error(res.data));
      });
    };
  }), _defineProperty(_ref5, 'create' + singleModelNameCap, function (model) {
    ...
    return function (dispatch) {
      ...
      try {
        return axios.post(baseUrl + '/' + urlModel, modelToCreate).then(function (res) {
