...
module.exports = function (modelName, hostConfig) {
  ...
  return _ref9 = {}, _defineProperty(_ref9, findModel, function (modelId) {
    function start() {
  ...
  }), _defineProperty(_ref9, findModels, function () {
  ...
  }), _defineProperty(_ref9, createModel, function (model) {
  ...
  }), _defineProperty(_ref9, updateModel, function (oldModel, newModel) {
    function start() {
      return _defineProperty({
  ...
  }), _defineProperty(_ref9, destroyModel, function (oldModel, newModel) {
    function start() {
      return _defineProperty({
        type: SINGLE_UPDATE_START
      }, singleModelName, newModel);
    ...
    function success(validatedModel) {
      ...
      return _ref8 = {
        type: SINGLE_UPDATE_SUCCESS
      }, _defineProperty(_ref8, singleModelName, validatedModel), _defineProperty(_ref8, 'message', singleModelName + ' has been updated'), _ref8;
    }
    function error(error) {
      return {
        type: SINGLE_UPDATE_ERROR,
