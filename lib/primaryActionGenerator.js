...
module.exports = function (modelName, hostConfig) {
  ...
  return _ref5 = {}, _defineProperty(_ref5, findModel, function (modelId) {
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'get', baseUrl + '/' + urlModel + '/' + modelId, headers[findModel]).then(function (res) {
        return dispatch(success(res));
      }).catch(function (res) {
        return dispatch(error(res, modelId));
      });
    };
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'get', baseUrl + '/' + urlModel + request, headers[findModels]).then(function (res) {
        return dispatch(success(res));
      }).catch(function (res) {
    ...
    return function (dispatch) {
      ...
      return providerUtil(hostConfig, 'post', baseUrl + '/' + urlModel, headers[createModel], modelToCreate).then(function (res) {
        return dispatch(success(modelWithTmpId));
      }).catch(function (res) {
        return dispatch(error(res, modelWithTmpId));
      });
    };
  }), _ref5;
};